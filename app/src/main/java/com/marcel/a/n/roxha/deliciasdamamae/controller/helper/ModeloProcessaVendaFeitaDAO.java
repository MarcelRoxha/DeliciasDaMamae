...
public class ModeloProcessaVendaFeitaDAO implements InterfaceModeloProcessaVendaFeitaDAO {
    ...
    public ModeloProcessaVendaFeitaDAO(Context context) {
        ...
        nomeCollectionNomeCaixaDiario = COLLECTION_CAIXA_DIARIO + dataCompleta;
    }
    ...
    public boolean processaVendaFeita(BolosModel bolosModel, String verificaTipoDeVenda, String verificaTipoDeMetodoDePagamento) {
        String mesReferenciaDesseMontante = mesAtual + "_" + anoAtual;
        nomeCollectionNomeMontanteMensal = COLLECTION_MONTANTE_MENSAL + mesReferenciaDesseMontante;
        Map<String, Object> montanteMensalAtualizandoDevidoAVenda = new HashMap<>();
        Map<String, Object> montanteDiarioAtualizandoDevidoAVenda = new HashMap<>();
                            ...
                            firebaseFirestore.collection(nomeCollectionNomeMontanteMensal).document(idRecuperado).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                ...
                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                    ...
                                    if (verificaTipoDeVenda.equals("IFOOD")) {
                                        ...
                                        montanteMensalAtualizandoDevidoAVenda.put("valorTotalVendasIfoodMensal", vendasDependendoDaPlataformaConvert);
                                        ...
                                        double resultadoDeVendasDependendoDaPlataform = valorQuePrecisaAtualizarDeVendasDependendoDaPlataformaConvert + valorQueOProdutoFoiVendidoConvert;
                                        String vendasDependendoDaPlataformaConvert = String.valueOf(resultadoDeVendasDependendoDaPlataform);
                                        montanteMensalAtualizandoDevidoAVenda.put("valorTotalVendasBoleriaMensal", vendasDependendoDaPlataformaConvert);
                                    ...
                                    if (verificaTipoDeMetodoDePagamento.equals("DINHEIROOUPIX")) {
                                        ...
                                        double resultadoDeVendasDependendoDaPlataform = valorQuePrecisaAtualizarDeVendasDependendoDaPlataformaConvert + valorQueOProdutoFoiVendidoConvert;
                                        String vendasDependendoDaPlataformaConvert = String.valueOf(resultadoDeVendasDependendoDaPlataform);
                                        montanteMensalAtualizandoDevidoAVenda.put("valorTotalDeVendasNoDinheiroDesseMes", vendasDependendoDaPlataformaConvert);
                                        ...
                                        double resultadoDeVendasDependendoDaPlataform = valorQuePrecisaAtualizarDeVendasDependendoDaPlataformaConvert + valorQueOProdutoFoiVendidoConvert;
                                        String vendasDependendoDaPlataformaConvert = String.valueOf(resultadoDeVendasDependendoDaPlataform);
                                        montanteMensalAtualizandoDevidoAVenda.put("valorTotalDeVendasNoCreditoDesseMes", vendasDependendoDaPlataformaConvert);
                                        ...
                                        double resultadoDeVendasDependendoDaPlataform = valorQuePrecisaAtualizarDeVendasDependendoDaPlataformaConvert + valorQueOProdutoFoiVendidoConvert;
                                        String vendasDependendoDaPlataformaConvert = String.valueOf(resultadoDeVendasDependendoDaPlataform);
                                        montanteMensalAtualizandoDevidoAVenda.put("valorTotalDeVendasNoDebitoDesseMes", vendasDependendoDaPlataformaConvert);
                                    ...
                                    String vendasDependendoDaPlataformaConvert = String.valueOf(resultadoDeVendasDependendoDaPlataform);
                                    montanteMensalAtualizandoDevidoAVenda.put("valorTotalVendasEmGeralMensal", vendasDependendoDaPlataformaConvert);

                                    firebaseFirestore.collection(nomeCollectionNomeMontanteMensal).document(idRecuperado).update(montanteMensalAtualizandoDevidoAVenda).addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void unused) {
                                            Toast.makeText(context, "MONTANTE ATUALIZADO", Toast.LENGTH_SHORT).show();
                                            firestore.collection(nomeCollectionNomeMontanteMensal).document(idRecuperado).collection(nomeCollectionNomeCaixaDiario).whereEqualTo("dataReferenciaMontanteDiarioDesseDia", dataCompleta).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                                                @Override
                                                public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                                    ...
                                                    if (listaDoCaixaDesseDia.size() > 0) {
                                                        for (DocumentSnapshot list : listaDoCaixaDesseDia) {
                                                            ...
                                                            firestore.collection(nomeCollectionNomeMontanteMensal).document(idRecuperado).collection(nomeCollectionNomeCaixaDiario).document(idRecuperadoDiario).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                                @Override
                                                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                                    ...
                                                                    if (verificaTipoDeVenda.equals("IFOOD")) {
                                                                        ...
                                                                        montanteDiarioAtualizandoDevidoAVenda.put("valorTotalDeVendasNoIfoodDesseDia", vendasDependendoDaPlataformaConvertDiario);
                                                                        ...
                                                                        double resultadoDeVendasDependendoDaPlataformDario = valorQuePrecisaAtualizarDeVendasDependendoDaPlataformaConvertDario + valorQueOProdutoFoiVendidoConvert;
                                                                        String vendasDependendoDaPlataformaConvertDiario = String.valueOf(resultadoDeVendasDependendoDaPlataformDario);
                                                                        montanteDiarioAtualizandoDevidoAVenda.put("valorTotalDeVendasNaLojaDesseDia", vendasDependendoDaPlataformaConvertDiario);
                                                                    ...
                                                                    if (verificaTipoDeMetodoDePagamento.equals("DINHEIROOUPIX")) {
                                                                        ...
                                                                        montanteDiarioAtualizandoDevidoAVenda.put("valorTotalDeVendasNoDinheiroDesseDia", vendasDependendoDaPlataformaConvertvalorQuePrecisaraSerSomadoDependendoDeOndeSaiuAVendaDiario);
                                                                        ...
                                                                        montanteDiarioAtualizandoDevidoAVenda.put("valorTotalDeVendasNoCreditoDesseDia", vendasDependendoDaPlataformaConvertDiario);
                                                                        ...
                                                                        double resultadoDeVendasDependendoDaPlataformDiario = valorQuePrecisaAtualizarDeVendasDependendoDaPlataformaConvertDiario + valorQueOProdutoFoiVendidoConvert;
                                                                        String vendasDependendoDaPlataformaConvertDiario = String.valueOf(resultadoDeVendasDependendoDaPlataformDiario);
                                                                        montanteDiarioAtualizandoDevidoAVenda.put("valorTotalDeVendasNoDebitoDesseDia", vendasDependendoDaPlataformaConvertDiario);
                                                                    ...
                                                                    String vendasDependendoDaPlataformaConvertDiario = String.valueOf(resultadoDeVendasDependendoDaPlataformDiario);
                                                                    montanteDiarioAtualizandoDevidoAVenda.put("valorTotalDeVendasEmGeralDesseDia", vendasDependendoDaPlataformaConvertDiario);
                                                                    firestore.collection(nomeCollectionNomeMontanteMensal).document(idRecuperado).collection(nomeCollectionNomeCaixaDiario).document(idRecuperadoDiario).update(montanteDiarioAtualizandoDevidoAVenda)
